...
class LucideSvgIconTest {
    ...
    @Test
    @DisplayName("setSize with IconSize enum works")
    void setSizeIconSize() {
        LucideSvgIcon icon = LucideIconFactory.create("save");
        icon.setSize(LucideSvgIcon.IconSize.M);
        assertEquals("24px", icon.getStyle().get("width"));
        assertEquals("24px", icon.getStyle().get("height"));
    }

    @Test
    @DisplayName("setSize with IconSize.XXL")
    void setSizeIconSizeXXL() {
        LucideSvgIcon icon = LucideIconFactory.create("save");
        icon.setSize(LucideSvgIcon.IconSize.XXL);
        assertEquals("64px", icon.getStyle().get("width"));
        assertEquals("64px", icon.getStyle().get("height"));
    }
